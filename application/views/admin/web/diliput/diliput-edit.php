<div id="page-wrapper">
<div class="row">
	<h1>Edit Data Liputan</h1>
	<div class="col-lg-12">
		<div class="panel-body">
			<div class="text-center" style="margin:25px">
				<?=img('/diliput/'.$data->gambar,array('class'=>'img img-circle','style'=>'height:200px'))?>
			</div>
			<form method="post" action="<?=site_url('/admin/diliput/do_edit')?>" enctype="multipart/form-data">
	      <div class="form-group input-group">
	          ...
	          <input type="text" class="form-control" name="link" required="" value="<?=$data->link?>"/>
				...
				<a class="pull-right btn btn-danger" href="<?=site_url('/admin/diliput/delete/'.$data->id)?>">Delete</a>
