...
<div class="row">
	<div class="col-lg-12">
		<h1>List Poster</h1></h1><a class="btn btn-primary" href="<?=site_url('/admin/poster/add_new')?>">Add New</a>
		<div class="panel-body">
			<div class="table-responsive">
              ...
              <td class="center"><a class="btn btn-primary" href="<?=site_url('admin/poster/edit/'.$row->id)?>">Edit</a></td>
            </tr>
						<?php } ?>
					</tbody>
				</table>
